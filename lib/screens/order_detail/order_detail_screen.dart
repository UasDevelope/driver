...
//                     const SizedBox(height: 8),
//                     _buildStatsRow(),
//                     // EarningsGraph(earnings: Earning,),
//                     const SizedBox(height: 16),
//                     _buildRecentOrdersHeader(),
//                     const SizedBox(height: 8),
//                     ...orderSummary.recentOrders.map((day) => OrderDayItem(booking: day)).toList(),
//                   ],
//                 ),
//               ],
//             ),
...
//   const OrderDayItem({required this.booking});
//
//   @override
//   Widget build(BuildContext context) {
//     return Column(
...
//           itemCount: booking.orders.length,
...
//             final order = booking.orders[index];
//             return Padding(
